...
// 			$("#message").hide();
// 			$("#submit").after('<img src="../images/status.gif" class="loader">').attr("disabled","disabled");
// 			$.post(e,{
// 				name:$("#name").val(),
// 				email:$("#email").val(),
// 				phone:$("#phone").val(),
...
// 				verify:$("#verify").val()},
// 				function(e){document.getElementById("message").innerHTML=e;

// 				$("#message").slideDown(300);$("#contactform img.loader").fadeOut(300,function(){
// 					$(this).remove()});
